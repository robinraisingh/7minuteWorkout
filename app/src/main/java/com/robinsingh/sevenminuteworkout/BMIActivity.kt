...
class BMIActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(actionbar!=null){
            actionbar.setDisplayHomeAsUpEnabled(true)//this will set the bal buttom
            actionbar.title="CALCULATE BMI"//set up title
        }
        toolbar_bmi_activity.setNavigationOnClickListener {
            onBackPressed()  //action on the back button will b the action of top button "<-"
        }
